...
func NewUI(cr *ChatRoom) *UI {
	...
	titlebox := tview.NewTextView().
		SetText(fmt.Sprintf("HBXchat. A P2P Chat Application. %s", appversion)).
	...
	usage := tview.NewTextView().
		SetDynamicColors(true).
		SetText(`[red]/quit[blue] - quit the chat | [red]/room <roomname>[blue] - change chat room | [red]/user <username>[blue] - change user name | [red]/clear[blue] - clear the chat`)
