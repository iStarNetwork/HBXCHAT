...
func (p2p *P2P) AdvertiseConnect() {
	...
	// Debug log
	logrus.Debugln("Advertised the HBXchat Service.")
	...
	// Trace log
	logrus.Traceln("Discovered HBXchat Service Peers.")
...
func (p2p *P2P) AnnounceConnect() {
	...
	// Debug log
	logrus.Debugln("Announced the HBXchat Service.")
	// Sleep to give time for the advertisment to propogate
	time.Sleep(time.Second * 5)
